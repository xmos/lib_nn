...
namespace nn {
  ...
  /**
   * This class ultimately just decorates subclasses with some static fields and methods related
   * to its channel-wise parallelism
   */
  ...
  template <int N_channels_per_cog_log2>
  constexpr int ChannelParallelComponent<N_channels_per_cog_log2>::ChannelsPerOutputGroupLog2;
  template <int N_channels_per_cog_log2>
  constexpr int ChannelParallelComponent<N_channels_per_cog_log2>::ChannelsPerOutputGroup;
