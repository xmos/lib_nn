...
class ImageGeometry {
 public:
   ...
   */
  inline int RowElements() const { return this->width * this->PixelElements(); }

  /**
   * The number of image elements per column of the image, i.e. height x
   * channels
   */
  inline int ColElements() const { return this->height * this->PixelElements(); }

  /**
   * The total number of image elements, i.e. width x height x channels
   */
  inline int ElementCount() const { return this->height * this->RowElements(); }

  /**
   * The number of image pixels multiplied by the square of image depth
   */
  inline int VolumeElements() const { return this->depth * this->ElementCount(); }
   ...
   */
  inline int RowBytes() const { return RowElements() * element_bits / CHAR_BIT; }

  /**
   * The number of bytes per column of the image
   */
  inline int ColBytes() const { return ColElements() * element_bits / CHAR_BIT; }

  /**
   * The total number of bytes of the image
   */
  inline int ImageBytes() const { return ElementCount() * element_bits / CHAR_BIT; }
