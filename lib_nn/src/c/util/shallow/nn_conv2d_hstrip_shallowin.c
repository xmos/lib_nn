...
void nn_conv2d_hstrip_shallowin(nn_image_t* Y, const nn_image_t* X,
  ...
  nn_conv2d_hstrip_shallowin_ref(Y, X, K, BSO, K_h, K_h_stride, C_in,
...
void nn_conv2d_hstrip_shallowin_padded(
    ...
    const mem_stride_t x_v_stride, const mem_stride_t y_h_stride,
    const unsigned out_cols, const int8_t* zero_point_vec) {
  nn_conv2d_hstrip_shallowin_padded_ref(
      Y, X, K, BSO, K_h, K_h_stride, C_in, pad_t, pad_b, pad_l_initial,
      pad_r_initial, x_v_stride, y_h_stride, out_cols, zero_point_vec);
}
...
void nn_conv2d_hstrip_tail_shallowin_padded(
    ...
    const unsigned out_cols, const int8_t* zero_point_vec,
    const channel_count_t C_out_tail) {
  nn_conv2d_hstrip_tail_shallowin_padded_ref(
      Y, X, K, BSO, K_h, K_h_stride, C_in, pad_t, pad_b, pad_l_initial,
      pad_r_initial, x_v_stride, y_h_stride, out_cols, zero_point_vec,
      C_out_tail);
}
