  ...
  class Conv2dDeepFilter_Valid
  {
    ...
    *********/
    public:
      ...
      using InputGeometry = ImageGeometry;
      using OutputGeometry = ImageGeometry;
      ...
      */
      struct Config {
          ...
          Config(const InputGeometry& input_geom,
            ...
            : input{input_geom.getAddressCovector<int8_t>()}, 
              output{ output_geom.getAddressCovector<int8_t>(), 
    ...
    ********/
    public:
      ...
      static nn::PredicateFilterGeometryIterator GetGeometryIterator();
