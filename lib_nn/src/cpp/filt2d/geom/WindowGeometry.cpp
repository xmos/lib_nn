...
{
  return this->shape.height == other.shape.height && this->shape.width == other.shape.width && this->shape.depth == other.shape.depth && this->start.row == other.start.row && this->start.col == other.start.col && this->stride.row == other.stride.row && this->stride.col == other.stride.col && this->stride.channel == other.stride.channel && this->dilation.row == other.dilation.row && this->dilation.col == other.dilation.col;
}
