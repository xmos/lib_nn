...
## Building
For an VX4A XCore build:

    cmake -B build_vx4a -DCMAKE_TOOLCHAIN_FILE=etc/vx4a.cmake ..
    make -C build_vx4a

For an XS3A XCore build:

    cmake -B build_xs3a -DCMAKE_TOOLCHAIN_FILE=etc/xs3a.cmake ..
    make -C build_xs3a
