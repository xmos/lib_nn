 ...
 *
 */
class Conv2dDepthwiseReferenceTestA
...
INSTANTIATE_TEST_SUITE_P(
    Basic, Conv2dDepthwiseReferenceTestA,
    ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(Random, Conv2dDepthwiseReferenceTestA,
...
class Conv2dDepthwiseReferenceTestB
    : public ::testing::TestWithParam<Filter2dGeometry> {};
...
INSTANTIATE_TEST_SUITE_P(Random, Conv2dDepthwiseReferenceTestB,
