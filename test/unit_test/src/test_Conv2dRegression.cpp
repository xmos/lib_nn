                          ...
                          for (int right_pad = 0; right_pad <= 1; ++right_pad) {
                            for (int bottom_pad = 0; bottom_pad <= 1;
                              ...
                              for (int itt = 0; itt < itt_count; ++itt) {
                                ...
                                nn::execute(&output[0], &input[0], &conv2d,
                                            &akp, &T[0]);
                          ...
                          for (int right_pad = 0; right_pad <= 0; ++right_pad) {
                            for (int bottom_pad = 0; bottom_pad <= 0;
                              ...
                              for (int itt = 0; itt < itt_count; ++itt) {
                                ...
                                Conv2dValidIndirect conv2d(&memcpy, &aggregator,
                                                           &ot);
                          ...
                          for (int right_pad = 0; right_pad <= 0; ++right_pad) {
                            for (int bottom_pad = 0; bottom_pad <= 0;
                              ...
                              for (int itt = 0; itt < itt_count; ++itt) {
                                ...
                                Conv2dValidDirect conv2d(&memcpy, &aggregator,
                                                         &ot);
...
void test_Conv2dValidDirectRegression_2() {
  for (int x_height = 1; x_height <= 3; ++x_height) {
    for (int x_width = 1; x_width <= 3; ++x_width) {
      for (int x_channels = 32; x_channels <= 64; x_channels += 32) {
        for (int k_height = 1; k_height <= x_height; ++k_height) {
                          ...
                          for (int right_pad = 0; right_pad <= 0; ++right_pad) {
                            for (int bottom_pad = 0; bottom_pad <= 0;
                              ...
                              for (int itt = 0; itt < itt_count; ++itt) {
                                ...
                                // DerefInputFn::Params im_to_col_params(X, K);
                                // Deref_MemcpyFn_Params_t *m = (Deref_MemcpyFn_Params_t *)&im_to_col_params;
                                // DerefInputFn memcpy(&im_to_col_params);
                                DerefInputFn memcpy(X,K);
                                Deref_MemcpyFn_Params_t m = memcpy.getParams();


                                nn_conv_params_t params;
                                params.memcopy_fn = (int8_t* (*)(const void*, int8_t*, int8_t*, int32_t, int32_t, int32_t))deref_memcopy_fn;
                                params.aggregate_fn = (void (*)(const void *, VPURingBuffer*, int8_t*, int32_t, int8_t*))mat_mul_fn_int8_direct_impl;
                                params.output_transform_fn = (int8_t* (*)(const void*, int8_t *, VPURingBuffer*, int32_t, int16_t*))output_transform_fn_impl;
                                ...
                                Direct_AggFn_Params_t agg = aggregator.getParams();
                                ...
                                Output_Transform_Params_t o = ot.getParams();
                                ...
                                Filter2D::Params akp(Y, ir,
                                                     VPU_INT8_ACC_PERIOD);
                                AbstractKernel_Params_t *a = (AbstractKernel_Params_t*)&akp;
                                ...
                                nn::execute_p(&output[0], &input[0], &params,
...
void test_conv2d_regression() {
  ...
  RUN_TEST(test_Conv2dValidDirectRegression_2);
