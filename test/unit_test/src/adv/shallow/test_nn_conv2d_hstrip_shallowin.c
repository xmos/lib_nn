...
void test_nn_conv2d_hstrip_shallowin_case0() {
  ...
  for (int v = start_case; v < N_casses && v <= stop_case; v++) {
    ...
    nn_conv2d_hstrip_shallowin((nn_image_t*)Y, (nn_image_t*)X, K_init,
                               (nn_bso_block_t*)&bso, K_h, K_hstride,
                               x_params.channels, x_v_stride, y_params.channels,
                               y_params.width);
...
void test_nn_conv2d_hstrip_shallowin_case1() {
  ...
  for (int v = start_case; v < N_casses && v <= stop_case; v++) {
    ...
    memset(Y, 0xCC, sizeof(Y));
    nn_conv2d_hstrip_shallowin((nn_image_t*)Y, X_patch_start, K_init,
                               (nn_bso_block_t*)&bso, K_h, K_hstride,
                               x_params.channels, x_v_stride, y_params.channels,
                               y_params.width);
...
void test_nn_conv2d_hstrip_shallowin_case3() {
  ...
  int16_t shift1s[] = {10, 11, 26, 26, 26, 26, 9,  10,
                       11, 26, 26, 26, 26, 9,  10, 11};
  for (int k = 0; k < y_params.channels; k++) {
    BSO.bias[k] = -100 * k;
    BSO.shift1[k] = shift1s[k];
    BSO.scale[k] = 8;
...
#define K_w (1)
#define K_hstride (1)
void test_nn_conv2d_hstrip_shallowin_case4() {
  PRINTF("%s...\n", __func__);
...
void test_nn_conv2d_hstrip_shallowin() {
  ...
  RUN_TEST(test_nn_conv2d_hstrip_shallowin_case4);
}