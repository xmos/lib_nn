...
void test_nn_conv2d_hstrip_shallowin_padded_case0() {
  ...
  for (int v = start_case; v < N_casses && v <= stop_case; v++) {
    ...
    nn_conv2d_hstrip_shallowin_padded(
        ...
        K_hstride, x_params.channels, pad_t, pad_b, pad_l, pad_r, x_v_stride,
        y_params.channels, y_params.width, zero_point_vec);
...
#define K_w (1)
#define K_hstride (1)
void test_nn_conv2d_hstrip_shallowin_padded_case6() {
  PRINTF("%s...\n", __func__);
...
void test_nn_conv2d_hstrip_shallowin_padded() {
  ...
  RUN_TEST(test_nn_conv2d_hstrip_shallowin_padded_case6);
}