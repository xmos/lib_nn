...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//  Case 0 - Basic functionality w/  C_out = 16  and C_in = 32. No input or
//  output tails.
//

...
#define ceil_C_out                                                   \
  (((C_out + (VPU_INT8_ACC_PERIOD - 1)) >> VPU_INT8_ACC_PERIOD_LOG2) \
...
void test_fully_connected_16_case0() {
  ...
  for (int v = start_case; v < N_casses && v <= last_case; v++) {
    ...
    nn_standard_BSO_layout((nn_bso_block_t*)&BSO, (int32_t*)&BSO.B,
                           (int16_t*)&BSO.shift1, (int16_t*)&BSO.scale,
                           (int16_t*)&BSO.offset_scale, (int16_t*)&BSO.offset,
                           (int16_t*)&BSO.shift2, NULL, C_out);

    memset(Y, 0xCC, sizeof(Y));

    PRINTF("\t\tCalling %s...\n", TEST_TARGET);
    fully_connected_16((int16_t*)Y, (int8_t*)W, (int8_t*)X,
                       (nn_bso_block_t*)&BSO, C_in, 0, C_out);

    PRINTF("\t\tChecking...\n");
    char str_buff[200] = {0};
    for (unsigned c = 0; c < C_out; c++) {
      if (Y[c] != casse->y) sprintf(str_buff, "(vector: %u) (index: %u)", v, c);
...
void test_fully_connected_16_case6() {
  ...
  for (int v = start_case; v < N_casses && v <= last_case; v++) {
    ...
    for (int oddness = 0; oddness < 2; oddness++) {
      ...
      PRINTF("\t\t\tCalling %s...\n", TEST_TARGET);
      fully_connected_16((int16_t*)Y, (int8_t*)W, (int8_t*)X,
                         (nn_bso_block_t*)&BSO, C_in, 0, C_out_tmp);
      ...
      for (unsigned c = 0; c < C_out; c++) {
        ...
        if (oddness && c == C_out_tmp) exp_val = (int16_t)0xCCCC;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//  Case 7 -  C_out > 16 but not a multiple of 16. No Input tail.  (Tests even
//  AND odd C_out)
//

...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//  Case 9 -  Multiple input and output groups, with both input and output
//  tails.
//

...
void test_fully_connected_16_case9() {
  ...
  for (int v = start_case; v < N_casses && v <= last_case; v++) {
    ...
    for (unsigned c = 0; c < C_out; c++) {
      ...
      if (Y[c] != exp_val) sprintf(str_buff, "(vector: %u) (index: %u)", v, c);
...
void test_fully_connected_16_case10() {
  ...
  for (unsigned c = 0; c < C_out; c++) {
    ...
    if (Y[c] != exp_val) sprintf(str_buff, "(index: %u)", c);
...
void test_fully_connected_16_case11() {
  ...
  for (unsigned c = 0; c < C_out; c++) {
    ...
    // sum[0] = -24 * (C_in-1)*(C_in/2) - 64*(-24)*C_in = -24*(119)*(60) -
    // 64*(-24)*120
    //        = -171360 - -(184320) = 12960
    ...
    // after shift2: acc[c] = (((sum[c]+1) >> 1) * -(2**13) + (2**14) + (1<<13))
    // >> 14   // +(1<<13) is rounding logic
...
void test_fully_connected_16_case13() {
  ...
  case_t casses[] = {
      //  {  start,      count,     line     }
      {0, C_out, __LINE__}, {0, 1, __LINE__},   {0, 2, __LINE__},
      {0, 8, __LINE__},     {0, 17, __LINE__},  {0, 18, __LINE__},
      {0, 24, __LINE__},    {16, 1, __LINE__},  {16, 2, __LINE__},
      {16, 8, __LINE__},    {16, 17, __LINE__}, {16, 18, __LINE__},
      {16, 24, __LINE__},
  };
  ...
  for (int v = start_case; v < N_casses && v <= last_case; v++) {
    ...
    PRINTF("\t\t\tCalling %s...\n", TEST_TARGET);
    fully_connected_16((int16_t*)Y, (int8_t*)W, (int8_t*)X,
                       (nn_bso_block_t*)&BSO, C_in, casse->out_chan_start,
                       casse->out_chan_count);
    ...
    for (unsigned c = 0; c < C_out; c++) {
      ...
      if ((c < casse->out_chan_start) ||
          (c >= (casse->out_chan_start + casse->out_chan_count)))
        exp_val = 0xCCCC;

      if (Y[c] != exp_val)
        sprintf(str_buff, "(vector: %u) (index: %u) (line: %u)", v, c,
                casse->line);
