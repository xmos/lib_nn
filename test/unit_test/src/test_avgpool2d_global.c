...
static void compute_scale_shift(int8_t* out_scale, uint16_t* out_shift,
...
void test_avgpool2d_global_case0() {
  ...
  avgpool2d_global((nn_image_t*)Y, (nn_image_t*)X, bias, scale, shift,
                   &x_params);
...
void test_avgpool2d_global_case1() {
  ...
  const test_case_t casses[] = {
      //  X               //Chans     //Bias
      {1, 1, 16, 0},  // 0
      {2, 2, 16, 0},   {4, 4, 16, 0},    {6, 6, 16, 0},   {8, 8, 16, 0},
      {4, 2, 16, 0},  // 5
      {8, 6, 16, 0},   {2, 16, 16, 0},   {32, 16, 16, 0}, {32, 32, 16, 0},
      {2, 2, 32, 0},  // 10
      {2, 2, 48, 0},   {2, 2, 64, 0},    {2, 2, 4, 0},    {2, 2, 8, 0},
      {2, 2, 12, 0},  // 15
      {2, 2, 20, 0},   {2, 2, 24, 0},    {2, 2, 28, 0},   {2, 2, 36, 0},
      {4, 8, 40, 0},  // 20
      {12, 6, 12, 0},  {16, 2, 40, 0},   {4, 24, 36, 0},  {32, 32, 60, 0},
      {2, 2, 12, 1},  // 25
      {2, 2, 20, -10}, {2, 2, 24, 22},   {2, 2, 28, -13}, {2, 2, 36, 40},
      {4, 8, 40, -77},  // 30
      {12, 6, 12, 3},  {16, 2, 40, -20}, {4, 24, 36, 44}, {32, 32, 60, -100},
  };
