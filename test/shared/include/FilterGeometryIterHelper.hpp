...
namespace nn {
  namespace test {
    ...
    namespace unpadded {
       ...
       *
       */
      static inline nn::ff::FilterGeometryIterator AllUnpadded( const nn::Filter2dGeometry max_geometry,
       ...
       *
       */
      static inline nn::ff::FilterGeometryIterator SimpleDense( const std::array<int,2> output_spatial_range,
                                                                const std::array<int,2> window_spatial_range,
                                                                const std::array<int,2> out_channel_count_range,
                                                                const std::array<int,2> in_channel_count_range,
                                                                const int output_step = 1,
                                                                const int window_step = 1,
                                                                const int out_channel_step = 4,
        ...
        return FilterGeometryIterator( 
                                        ...
                                        nn::WindowGeometry(window_spatial_range[0], window_spatial_range[0], 1, 0, 0, 0, 0, 1, 1, 1 ) ), 
                  {
                    ...
                    new WindowShape( {window_spatial_range[0], window_spatial_range[0]},
                                     {window_spatial_range[1], window_spatial_range[1]},
                                     {window_step, window_step} ),
                    new InputDepth( in_channel_count_range[0], in_channel_count_range[1], in_channel_step),
    ...
    namespace padded {
       ...
       * 
       */
      static inline nn::ff::FilterGeometryIterator AllPadded( const nn::Filter2dGeometry max_geometry,
                                                              const nn::padding_t max_padding,
                                                              const bool depthwise = false,
                                                              const int channel_step = 4)
      {
        return FilterGeometryIterator({ 
