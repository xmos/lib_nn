...
namespace nn {
  namespace ff {
    ...
    {
      protected:
        virtual nn::ImageGeometry& Image() override { return this->filter.window.shape; }
      public:
    ...
    {
      public:
        InputShape(const std::array<int,3> min, 
    ...
    {
      public:
        OutputShape(const std::array<int,3> min, 
                    const std::array<int,3> max, 
                    const std::array<int,3> step)
    ...
    {
      public:
        WindowShape(const std::array<int,2> min, 
                    const std::array<int,2> max, 
     ...
     * 
     */
    class FilterGeometryIterator : public std::iterator<std::input_iterator_tag, nn::Filter2dGeometry>
    {
